...
curl -s --connect-timeout 3 https://github.com/qg888/Notes/raw/main/QL/N1/config/config.sh > $config_shell_path
...
curl -s --connect-timeout 3 https://github.com/qg888/Notes/raw/main/QL/N1/config/extra.sh > $extra_shell_path
...
curl -s --connect-timeout 3 https://github.com/qg888/Notes/raw/main/QL/N1/config/code.sh > $code_shell_path
...
# 下载 task_before.sh
curl -s --connect-timeout 3 https://github.com/qg888/Notes/raw/main/QL/N1/config/task_before.sh > $task_before_shell_path
